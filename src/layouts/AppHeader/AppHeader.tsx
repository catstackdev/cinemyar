      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-border sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          {breadcrumbs.length > 0 && (
            <div className="hidden lg:flex lg:flex-1 lg:ml-4">
          ...
          <div className="hidden lg:block">
            <form>
              ...
              {/*     className="h-11 w-full rounded-lg border border-input bg-background py-2.5 pl-12 pr-14 text-sm text-foreground shadow-theme-xs placeholder:text-muted-foreground focus:border-ring focus:outline-hidden focus:ring-3 focus:ring-ring/10 xl:w-[430px]" */}
              {/*   /> */}
              {/**/}
