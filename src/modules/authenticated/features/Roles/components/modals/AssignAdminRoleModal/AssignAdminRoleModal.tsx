...
import { useAdminAssignRole } from "../../../hooks/useAdminRoles";
...
const AssignAdminRoleModal: React.FC<AssignAdminRoleModalProps> = ({
  ...
  const { mutate: assignAdminRole, isPending: isAssigning } =
    useAdminAssignRole();
  ...
  const params: AdminUserListParams = useMemo(
    () => ({
      ...
      sortBy,
      orderBy,
      dynamicRoleId: filters.dynamicRoleId || undefined,
      exceptdynamicRoleId: item?.id || undefined,
      isBanned:
  ...
  return (
    <ModalRoot open={open} onOpenChange={onOpenChange}>
      <ModalContent
        ...
        zIndex={100}
      >
        <ModalHeader className="pr-16">Assign Admin Role</ModalHeader>
                        ...
                        <TableRow key={user.id}>
                          ...
                          <TableCell className="text-right">
                            <Button
                              ...
                              rightIcon={isAssigning && <JumpingDots />}
