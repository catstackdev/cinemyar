...
export const CONECTOR_X_PADDING: Record<StepperSize, string> = {
  sm: "px-4",
  md: "px-5",
  lg: "px-6",
};

export const CONECTOR_Y_POSITION: Record<StepperSize, string> = {
  sm: "top-4",
  md: "top-5",
  lg: "top-6",
};
...
export const STEP_STATUS_CLASSES: Record<
  string,
  Record<StepperColor, string>
> = {
  complete: {
  ...
  current: {
    primary:
      "bg-primary-100 dark:bg-primary-900 text-primary-900 dark:text-primary-100 border-2 border-primary ring-4 ring-primary/20",
    success:
      "bg-success-100 dark:bg-success-900 text-success-900 dark:text-success-100 border-2 border-success ring-4 ring-success/20",
    info: "bg-info-100 dark:bg-info-900 text-info-900 dark:text-info-100 border-2 border-info ring-4 ring-info/20",
    warning:
      "bg-warning-100 dark:bg-warning-900 text-warning-900 dark:text-warning-100 border-2 border-warning ring-4 ring-warning/20",
    danger:
      "bg-danger-100 dark:bg-danger-900 text-danger-900 dark:text-danger-100 border-2 border-danger ring-4 ring-danger/20",
  },
  upcoming: {
    primary:
      "bg-secondary-100 dark:bg-secondary-800 text-secondary-600 dark:text-secondary-400 border-2 border-secondary-300 dark:border-secondary-700",
    success:
      "bg-secondary-100 dark:bg-secondary-800 text-secondary-600 dark:text-secondary-400 border-2 border-secondary-300 dark:border-secondary-700",
  ...
  error: {
    primary:
      "bg-danger text-danger-foreground border-2 border-danger ring-4 ring-danger/20",
    success:
      "bg-danger text-danger-foreground border-2 border-danger ring-4 ring-danger/20",
...
export const CONNECTOR_STATUS_CLASSES: Record<
  string,
  Record<StepperColor, string>
> = {
  complete: {
